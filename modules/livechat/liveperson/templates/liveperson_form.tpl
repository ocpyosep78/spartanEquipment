<div style="margin-top: -20px; height:85%">
	...
	<form method="get" action="http://server.iad.liveperson.net/hc/" onsubmit="return ValidateLivePersonForm();">
		...
		<input type="hidden" name="url" value="{{ ShopPathNormal|raw }}" />
		<input type="hidden" name="returnUrl" value="{{ ShopPathNormal|raw }}/admin/index.php?ToDo=liveChatSettingsCallback&amp;module=livechat_liveperson&amp;func=PerformLivePersonRegistration" />
		<table class="Panel">
			<tr>
				<td class="FieldLabel">
				...
				<td>
					<input type="text" name="user" id="lp_username" class="Field200" value="{{ CurrentUser|raw }}" autocomplete="off" />
				</td>
			</tr>
			<tr>
				<td class="FieldLabel">
			...
			<tr>
				...
				<td>
					<input type="text" name="email" id="lp_email" class="Field200" value="{{ CurrentEmail|raw }}" autocomplete="off" />
				</td>
			</tr>
			<tr>
				<td class="FieldLabel">
