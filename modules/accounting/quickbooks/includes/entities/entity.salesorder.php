...
class ACCOUNTING_QUICKBOOKS_ENTITIES_SALESORDER extends ACCOUNTING_QUICKBOOKS_ENTITIES_BASE
{
	protected function xml()
	{
		...
		if (isc_strtolower($this->data->service) == 'salesordermod') {
			$reference = $this->quickbooks->getAccountingReference($this->data->nodeId, 'salesorder');
