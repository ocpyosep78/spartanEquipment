<select id="accounting_quickbooks_orderoption" class="Field250" name="accounting_quickbooks[orderoption]">
	<option value="receipt" {{ OrderTypeReceiptSelected|raw }}>{% lang 'QuickBooksShowSalesOrderOptionSalesReceipt' %}</option>
	<option value="order" {{ OrderTypeOrderSelected|raw }}>{% lang 'QuickBooksShowSalesOrderOptionSalesOrder' %}</option>
</select>
