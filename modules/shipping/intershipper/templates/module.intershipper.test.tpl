...
<table width="100%" style="background-color:#fff" class="Panel">
	...
	<tr>
		...
		<td>
			...
			<img style="margin-top:5px" src="../modules/shipping/intershipper/images/{{ Image|raw }}" />
	...
	<tr>
		...
		<td>
			...
			<input name="delivery_weight" id="delivery_weight" class="Field50">{{ Measurement|raw }}
