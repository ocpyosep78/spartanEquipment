	...
	*/
	...
	private function _Import()
	{
		...
		// Still importing, jump to next page
			...
			?>
			<script type="text/javascript" src="../javascript/jquery.js?<?php echo GetConfig('JSCacheToken'); ?>"></script>
			<script type="text/javascript" src="../javascript/jquery/plugins/idletimer/cookie.js?<?php echo GetConfig('JSCacheToken'); ?> "></script>
			<script type="text/javascript">
				window.onload = function()
				{
