<?php
	...
	define("AUTH_Manage_TruckTrader", 191);
	...
	class ISC_ADMIN_AUTH
	{
		...
		public function HandleSTSToDo($ToDo)
		{
			...
			else if(is_numeric(isc_strpos($do, "trucktrader"))) {
				$GLOBALS['ISC_CLASS_ADMIN_TRUCKTRADER'] = GetClass('ISC_ADMIN_TRUCKTRADER');
				$GLOBALS['ISC_CLASS_ADMIN_TRUCKTRADER']->HandleToDo($ToDo);
			}
