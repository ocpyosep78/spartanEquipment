 ...
 */
$GLOBALS['ISC_CFG']['AdminCopyright'] = 'Powered by <a target="_blank" href="http://www.interspire.com/shoppingcart/">Interspire Shopping Cart</a> %%VERSION%% &copy; 2004-'.date('Y').' Interspire Pty. Ltd.';
 ...
 */
$GLOBALS['ISC_LANG']['ReachedUserLimitMsg'] = "You cannot add any more users to your store because you have reached your limit of %s users. To add additional users, you need to <a href='http://www.interspire.com/shoppingcart/' target='_blank'>upgrade</a>.";
$GLOBALS['ISC_LANG']['ReachedProductLimitMsg'] = "You cannot add any more products to your store because you have reached your limit of %s products. To add additional products, you need to <a href='http://www.interspire.com/shoppingcart/' target='_blank'>upgrade</a>.";
...
$GLOBALS['ISC_CFG']["TemplatesOrderCustomURL"] = "http://www.interspire.com/shoppingcart/custom_design.php";
 ...
 */
$GLOBALS['ISC_CFG']['SystemInfoEditionUpgradeLink'] = "http://www.interspire.com/shoppingcart/";
 ...
 */
$GLOBALS['ISC_LANG']['TrialExpiresInXDays'] = 'Your free trial copy of Interspire Shopping Cart expires in %s days. <a href="http://www.interspire.com/shoppingcart/pricing.php" target="_blank">Click here for information on upgrading.</a>';
 ...
 * to be disabled.
 */
$GLOBALS['ISC_CFG']['DisableVideoWalkthrough'] = false;
