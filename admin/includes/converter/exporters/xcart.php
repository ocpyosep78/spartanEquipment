...
class ISC_ADMIN_EXPORTER_XCART extends ISC_ADMIN_EXPORTER
{
	 ...
	 */
	public $wizardTitle = 'XCartExportTitle';
	...
	public function InsertBrand($brandid, $brandData)
	{
	...
	public function InsertWishlist($wishlistid, $wishlistData)
	{
		$newWishlist = array(
	...
	*/
	public function FetchEmailByCustomerId($customerid)
	{
	...
	*/
	public function GetXCartISOCountry($country)
	{
		static $cache;
	 ...
	 * @return int The database row insert ID.
	 */
	public function DbMultiInsertArray($table, $values)
	{
