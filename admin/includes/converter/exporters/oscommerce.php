...
class ISC_ADMIN_EXPORTER_OSCOMMERCE extends ISC_ADMIN_EXPORTER
{
	...
	public function GetProductsOptionsId($optname)
	{
	...
	public function GetProductsOptionsValuesId($optvalue, $optid)
	{
		static $optcache, $last_id;
	...
	public function GetOsCommerceCountryId($country)
	{
		static $countrycache;
