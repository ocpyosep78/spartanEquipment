	...
	<input type="hidden" name="reviewId" value="{{ ReviewId|raw }}">
				...
				<tr>
				  <td class="Heading2" colspan=2>{% lang 'ReviewDetails' %}</td>
					...
					<tr>
						...
						<td>
							<input type="text" name="revtitle" class="Field300" value="{{ Title|raw }}">
					...
					<tr>
						...
						<td>
							<textarea name="revtext" rows="5" class="Field300">{{ Review|raw }}</textarea>
					...
					<tr>
						...
						<td>
							<input type="text" name="revfromname" class="Field300" value="{{ FromName|raw }}">
