<form action="index.php" id="frmSearch" method="get" onsubmit="return ValidateForm(CheckSearchForm)">
	...
	<div class="BodyContainer">
		<table class="OuterPanel">
		  <tr>
			<td class="Heading1" id="tdHeading">{% lang 'CreateNewShipmentsView' %}</td>
			</tr>
			<tr>
			<td class="Intro">
				<p>{% lang 'ShipmentViewIntro' %}</p>
				{{ Message|raw }}
				  ...
				  <table class="Panel">
					...
					<tr>
						...
						<td>
							...
							<img onmouseout="HideHelp('d2');" onmouseover="ShowHelp('d2', '{% lang 'NameThisView' %}', '{% lang 'NameThisShipmentsViewHelp' %}')" src="images/help.gif" border="0" />
