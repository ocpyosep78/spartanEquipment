	...
	<table cellSpacing="0" cellPadding="0" width="100%" style="margin-left: 4px; margin-top: 8px;">
		...
		<tr>
			<td class="Intro">
				...
				<p id="TemplateMsgBox">{{ Message|raw }}</p>
...
<script type="text/javascript" src="script/redirects.js?{{ JSCacheToken|raw }}"></script>
<script type="text/javascript" src="script/linker.js?{{ JSCacheToken|raw }}"></script>
