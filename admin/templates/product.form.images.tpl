...
ProductImages.newRowTemplate = {{ productImage_newRowTemplate_js|raw }};
ProductImages.swfUploadFileTypes = {{ productImage_swfUploadFileTypes_js|raw }};
...
$(function(){
	...
	{{ productImage_javascriptInitialiseCode|raw }}
