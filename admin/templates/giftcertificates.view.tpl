	...
	<table class="OuterPanel">
	  <tr>
		<td class="Heading1" id="tdHeading">{% lang 'CreateNewGiftCertificatesView' %}</td>
		</tr>
		<tr>
		<td class="Intro">
			<p>{% lang 'GiftCertificateViewIntro' %}</p>
			{{ Message|raw }}
			  ...
			  <table class="Panel">
				...
				<tr>
					...
					<td>
						...
						<img onmouseout="HideHelp('d2');" onmouseover="ShowHelp('d2', '{% lang 'NameThisView' %}', '{% lang 'NameThisGiftCertificatesViewHelp' %}')" src="images/help.gif" width="24" height="16" border="0">
			...
			<td>
			  <table class="Panel">
				...
				<tr>
					...
					<td>
						{% lang 'SearchFrom' %} &nbsp;{{ CurrencyTokenLeft|raw }}&nbsp;<input type="text" id="amountFrom" name="amountFrom" class="Field50"> {{ CurrencyTokenRight|raw }} {% lang 'SearchTo' %}
						&nbsp;{{ CurrencyTokenLeft|raw }}&nbsp;<input type="text" id="amountTo" name="amountTo" class="Field50"> {{ CurrencyTokenRight|raw }}
					</td>
				</tr>
				<tr>
					<td class="FieldLabel">
					...
					<td>
						{% lang 'SearchFrom' %} &nbsp;{{ CurrencyTokenLeft|raw }}&nbsp;<input type="text" id="balanceFrom" name="balanceFrom" class="Field50"> {{ CurrencyTokenRight|raw }} {% lang 'SearchTo' %}
						&nbsp;{{ CurrencyTokenLeft|raw }}&nbsp;<input type="text" id="balanceTo" name="balanceTo" class="Field50"> {{ CurrencyTokenRight|raw }}
					</td>
				</tr>
				<tr><td class="Gap" colspan="2"></td></tr>
			 </table>
