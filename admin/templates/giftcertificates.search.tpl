			...
			<td>
			  <table class="Panel">
				...
				<tr>
					...
					<td>
						{% lang 'SearchFrom' %} &nbsp;{{ CurrencyToken|raw }}&nbsp;<input type="text" id="amountFrom" name="amountFrom" class="Field50"> {% lang 'SearchTo' %}
						&nbsp;{{ CurrencyToken|raw }}&nbsp;<input type="text" id="amountTo" name="amountTo" class="Field50">
					</td>
				</tr>
				<tr>
					<td class="FieldLabel">
					...
					<td>
						{% lang 'SearchFrom' %} &nbsp;{{ CurrencyToken|raw }}&nbsp;<input type="text" id="balanceFrom" name="balanceFrom" class="Field50"> {% lang 'SearchTo' %}
						&nbsp;{{ CurrencyToken|raw }}&nbsp;<input type="text" id="balanceTo" name="balanceTo" class="Field50">
					</td>
				</tr>
				<tr><td class="Gap" colspan="2"></td></tr>
			 </table>
