	...
	<table cellspacing="0" cellpadding="0" width="100%"  align="center">
		...
		<tr>
		<td>
			<table class="GridPanel" cellspacing="0" cellpadding="0" border="0" id="IndexGrid" style="width:100%; display: {{ DisplayGrid|raw }}">
...
function PreviewNewTemplate(TemplateURL)
	{
		...
		TemplateURL = '{{ TemplatesPreviewPath|raw }}' + TemplateURL;

		var win = window.open("{{ TemplateWebsite|raw }}/"+TemplateURL, "preview", "width="+width+",height="+height+",top="+t+",left="+l);
		win.focus();
	}
