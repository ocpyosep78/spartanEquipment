	...
	<tr>
		<td>
			<table cellspacing="0" cellpadding="0">
				<tr>
					<td style="padding-bottom: 3px; padding-right: 10px; font-weight: bold;">%%LNG_PaymentMethod%%:</td>
					<td style="padding-bottom: 3px;">%%GLOBAL_PaymentMethod%%</td>
				</tr>
			</table>
		</td>
		<td>
			<table cellspacing="0" cellpadding="0">
				<tr>
					<td style="padding-bottom: 3px; padding-right: 10px; font-weight: bold;">%%LNG_ShippingMethod%%:</td>
					<td style="padding-bottom: 3px;">%%GLOBAL_ShippingMethod%%</td>
				</tr>
			</table>
		</td>
	</tr>
		...
		<td colspan="2">
			<table width="95%" border="0" align="right">
				<tr>
					...
					<td class="Heading2">%%LNG_Total%%</td>
				</tr>
