	...
	<tr>
		<td>
			<ul id="tabnav">
				...
				<li style="display: {{ HideInventoryTab|raw }};"><a href="#" id="tab2" onclick="ShowTab(2)">{% lang 'InventoryReport' %}</a></li>
			</ul>
		</td>
	</tr>
	<tr>
		<td>
			...
			<div id="dateBlock" style="padding:5px 0px 5px 10px" class="Text FloatLeft">
				<table border=0 cellspacing=0 cellpadding=0>
					<tr>
						...
						<td class="VendorSelect" style="background: #eee; padding: 3px 5px; {{ HideVendorList|raw }}" width="1">
			...
			<div id="div2" style="padding-top:10px; padding-left:10px; display: {{ HideInventoryTab|raw }};" class="text">
	...
	<script type="text/javascript">
		...
		var showProductInventory = '{{ ShowInventoryGrid|raw }}';
		...
		function LoadProductsByNumSoldGrid() {
			jQuery.ajax({url: 'index.php?ToDo=prodStatsByNumSoldGrid&vendorId={{ VendorId|raw }}&From={{ FromStamp|raw }}&To={{ ToStamp|raw }}&Page='+productsByNumSoldCurrentPage+'&Show='+productsPerPage+'&SortBy='+productsByNumSoldSortField+'&SortOrder='+productsByNumSoldSortOrder,
		...
		function LoadProductsByNumViewsGrid() {
			jQuery.ajax({url: 'index.php?ToDo=prodStatsByNumViewsGrid&vendorId={{ VendorId|raw }}&Page='+productsByNumViewsCurrentPage+'&Show='+productsPerPage+'&SortBy='+productsByNumViewsSortField+'&SortOrder='+productsByNumViewsSortOrder,
					 success: function(data) {
		...
		function LoadProductsByInventoryGrid() {
			...
			jQuery.ajax({url: 'index.php?ToDo=prodStatsByInventoryGrid&vendorId={{ VendorId|raw }}&Variations='+productsByInventoryVariations+'&Page='+productsByInventoryCurrentPage+'&Show='+productsPerPage+'&SortBy='+productsByInventorySortField+'&SortOrder='+productsByInventorySortOrder,
					 success: function(data) {
