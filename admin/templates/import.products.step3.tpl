	<div class="BodyContainer">
		...
		<tr>
			<td class="Heading1">{% lang 'ImportProductsStep3' %}</td>
		</tr>
		<tr>
			<td class="Intro">
				<p>{% lang 'ImportProductsStep3Desc' %}
				</p>
			</td>
		</tr>
		<tr>
	...
	<script type="text/javascript">
		...
		{
			tb_show('', 'index.php?ToDo=importProducts&Step=ImportFrame&ImportSession={{ ImportSession|raw }}&keepThis=true&TB_iframe=tue&height=240&width=400&modal=true', '');
