...
<body>
	...
	<div id="box">
		...
		<table>
			<tr>
				<td class="Heading1"><a href="index.php">{{ AdminLogo|raw }}</a></td>
			</tr>
			<tr>
				<td style="padding:0 0 0 10px">{% lang 'ResetPasswordIntro' %}</td>
			</tr>
			<tr>
				<td>{{ FlashMessages|raw }}</td>
			</tr>
			<tr>
			  <td>
				<table>
				<tr>
					...
					<td>
						<input type="text" name="username" id="username" class="Field150" value="{{ Username|raw }}">
					</td>
				</tr>
				<tr>
