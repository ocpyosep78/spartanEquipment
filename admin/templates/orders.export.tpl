			...
			<td>
			  <table class="Panel">
				...
				<tr>
					...
					<td>
						{% lang 'SearchFrom' %} {{ CurrencyToken|raw }}<input type="text" id="totalFrom" name="totalFrom" class="Field50"> {% lang 'SearchTo' %}
						{{ CurrencyToken|raw }}<input type="text" id="totalTo" name="totalTo" class="Field50">
					</td>
				</tr>
				<tr><td class="Gap" colspan="2"></td></tr>
			 </table>
