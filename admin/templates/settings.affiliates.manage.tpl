					...
					<table width="100%" class="Panel">
						<tr>
							...
							<td class="PanelBottom">
								<textarea name="AffiliateConversionTrackingCode" id="AffiliateConversionTrackingCode" rows="10" class="Field400 ISSelectReplacement">{{ AffiliateConversionTrackingCode|raw }}</textarea>
