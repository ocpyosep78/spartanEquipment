	...
	<table id="Table13" cellSpacing="0" cellPadding="0" width="100%">
		...
		<td class="Intro">
			...
			<td class="SmallSearch" align="right">
				...
				<form name="frmReturns" id="frmReturns" action="index.php?ToDo=viewReturns{{ SortURL|raw }}" method="get">
				<tr>
				...
				<tr>
					<td nowrap>
						...
						<span style="display:{{ HideClearResults|raw }}">| <a id="SearchClearButton" href="index.php?ToDo=viewReturns">{% lang 'ClearResults' %}</a></span>
					</td>
				</tr>
				</form>
				</table>
