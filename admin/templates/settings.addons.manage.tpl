					...
					<table width="100%" class="Panel">
						<tr>
							...
							<td class="PanelBottom">
								<select size="{{ AddonSelectBoxSize|raw }}" multiple name="addonpackages[]" id="addonpackages" class="Field250 ISSelectReplacement">
									{{ AddonProviders|raw }}
								</select>
	...
	<script type="text/javascript">
		...
		var hide_buttons_on_tabs = '{{ TabIdsToHideButtonsFrom|raw }}';
