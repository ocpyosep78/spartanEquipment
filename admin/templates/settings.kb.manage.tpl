	...
	<table cellSpacing="0" cellPadding="0" width="100%" style="margin-left: 4px; margin-top: 8px;">
		...
		<tr>
			<td class="Intro">
				<div class="IntroItem">{{ KBSettingsIntro|raw }}</div>
				{{ Message|raw }}
			</td>
		</tr>
		<tr>
				...
				<div id="div0" style="padding-top: 10px;">
					<table class="Panel">
						...
						<tr>
							...
							<td>
								<input type="text" name="KBPath" id="KBPath" class="Field200" value="{{ KBPath|raw }}">
						...
						<tr>
							...
							<td>
								<input type="checkbox" name="KBContactFormIntegration" id="KBContactFormIntegration" value="ON" {{ IsARSIntegrated|raw }}> <label for="KBContactFormIntegration">{% lang 'YesKBContactFormIntegration' %}</label>
						...
						<tr id="ARSFields" style="display:{{ HideARSFields|raw }}">
							<td class="FieldLabel">
								&nbsp;
							</td>
							<td>
	...
	<script type="text/javascript">
		...
		$('#KBContactFormIntegration').click(function() {
			if(this.checked && "{{ CanIntegrateARS|raw }}" == "0") {
				alert("{% lang 'NoContactPagesForActiveKB' %}");
				this.checked = false;
				$('#ARSFields').hide();
				return;
