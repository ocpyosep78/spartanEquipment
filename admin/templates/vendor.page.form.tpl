<form action="index.php?ToDo={{ FormAction|raw }}" id="frmPage" method="post" onsubmit="return ValidateForm(CheckPageForm)">
			...
			<td>
				<table width="100%" class="Panel">
					...
					<tr>
						...
						<td>
							<input type="text" name="pagetitle" id="pagetitle" class="Field250" value="{{ PageTitle|raw }}" />
					...
					<tr>
						...
						<td>
							<input type="checkbox" id="pagevisible" name="pagevisible" value="1" {{ Visible|raw }}> <label for="pagevisible">{% lang 'YesPageVisible' %}</label>
...
<script type="text/javascript">
	...
	function ConfirmCancel()
	{
		if(confirm('{% lang 'ConfirmCancel' %}')) {
			window.location = 'index.php?ToDo=editVendor&vendorId={{ VendorId|raw }}&currentTab=1';
		}
