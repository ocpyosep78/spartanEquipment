	<form action="index.php?ToDo=saveUpdatedGiftCertificateSettings" name="frmGiftCertificateSettings" id="frmGiftCertificateSettings" method="post" onsubmit="return ValidateForm(CheckGiftCertificateSettingsForm)">
		...
		<div class="MessageBox MessageBoxInfo" style="">{{ ManageGiftCertificateTemplatesNotice|raw }}</div>
		{% endif %}
			...
			<td>
				<table width="100%" class="Panel">
					...
					<tr>
						...
						<td>
							<label><input type="checkbox" name="EnableGiftCertificates" id="EnableGiftCertificates" value="1" {{ IsEnableGiftCertificates|raw }} onclick="ToggleGiftCertificatesStatus(this.checked)" /> {% lang 'YesEnableGiftCertificates' %}</label>
					...
					<tr class="HideOnDisabled">
						...
						<td style="padding-left: 25px;">
							<label><input type="radio" name="GiftCertificateCustomAmounts" id="GiftCertificateCustomAmountsNo"  onclick="$('#AmountsSelect').show();  $('#AmountsRange').hide();" value="0" {{ IsGiftCertificateSelectAmounts|raw }} /> {% lang 'GiftCertificateSelectAmounts' %}</label><br />
							<div id="AmountsSelect" style="display: {{ HideSelectAmounts|raw }}">
								<img src="images/nodejoin.gif" style="vertical-align: top;" />
								<textarea name="GiftCertificateAmounts" id="GiftCertificateAmounts" class="Field250" rows="6">{{ GiftCertificateAmountsArea|raw }}</textarea>
							...
							<label><input type="radio" onclick="$('#AmountsSelect').hide(); $('#AmountsRange').show();" name="GiftCertificateCustomAmounts" id="GiftCertificateCustomAmounts" value="1" {{ IsGiftCertificateCustomAmounts|raw }} />{% lang 'GiftCertificateCustomAmounts' %}</label>
							<div id="AmountsRange" style="display: {{ HideCustomAmounts|raw }}">
								<img src="images/nodejoin.gif" style="vertical-align: middle;" />
								{% lang 'GiftCertificateMinAmount' %} {{ CurrencyTokenLeft|raw }} <input type="text" name="GiftCertificateMinimum" id="GiftCertificateMinimum" value="{{ GiftCertificateMinimum|raw }}" class="Field40" /> {{ CurrencyTokenRight|raw }}
								&nbsp;&nbsp;&nbsp;
								{% lang 'GiftCertificateMaxAmount' %} {{ CurrencyTokenLeft|raw }} <input type="text" name="GiftCertificateMaximum" id="GiftCertificateMaximum" value="{{ GiftCertificateMaximum|raw }}" class="Field40" /> {{ CurrencyTokenRight|raw }}
							</div>
						</td>
					</tr>
					...
					<tr class="HideOnDisabled">
						...
						<td style="padding-left: 25px;" class="PanelBottom">
							<label><input type="checkbox" name="EnableGiftCertificateExpiry" id="EnableGiftCertificateExpiry" value="1" onclick="if(this.checked == true) { $('#EnableExpiryOptions').show(); } else { $('#EnableExpiryOptions').hide(); }" {{ IsGiftCertificateExpiry|raw }} /> {% lang 'YesEnableGiftCertificateExpiry' %}</label>
							...
							<div id="EnableExpiryOptions">
								...
								<input type="text" name="GiftCertificateExpiry" id="GiftCertificateExpiry" value="{{ ExpiresAfter|raw }}" class="Field40" />
