...
<div id="content">
	<form action="index.php?ToDo=" method="post" id="templateForm" onsubmit="return false;" accept-charset="utf-8">
		...
		<p>
			{{ lang.EbayCreateTemplateIntro|raw }}
		</p>
...
<script type="text/javascript">//<![CDATA[
	$(document).ready(function() {
		...
		{% if templateId %}
			...
			EbayTemplate.primaryCategoryOptions = {{ primaryCategoryOptions|raw }};
			EbayTemplate.secondaryCategoryOptions = {{ secondaryCategoryOptions|raw }};
			EbayTemplate.primaryStoreCategoryOptions = {{ primaryStoreCategoryOptions|raw }};
			EbayTemplate.secondaryStoreCategoryOptions = {{ secondaryStoreCategoryOptions|raw }};
		{% endif %}
