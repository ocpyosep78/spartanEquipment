	...
	<div class="BodyContainer">
		<input type="hidden" id="enableSortable" value="{{ FormFieldsIsSortable|raw }}" />
		...
		<tr>
			<td>
				<input type="hidden" id="CurrentFormFieldsFormId" name="CurrentFormFieldsFormId" value="{{ FormFieldsAccountFormId|raw }}" />
				<ul id="FormFieldsSectionNav" class="tabnav">
					<li><a href="#" class="active" id="FormFieldsSection_{{ FormFieldsAccountFormId|raw }}" onclick="ChangeFormFieldsTab({{ FormFieldsAccountFormId|raw }});">{{ FormFieldsSectionAccount|raw }}</a></li>
					<li><a href="#" id="FormFieldsSection_{{ FormFieldsAddressFormId|raw }}" onclick="ChangeFormFieldsTab({{ FormFieldsAddressFormId|raw }});">{{ FormFieldsSectionAddress|raw }}</a></li>
				</ul>
			</td>
		</tr>
		<tr>
			<td style="{{ HideFormFieldsButtons|raw }}">
				<p class="Intro">
					<button id="ViewsMenuButton" class="PopDownMenu FormButton FormFieldsMenuButton" style="display:{{ FormFieldsHideAddButton|raw }}">{% lang 'FormFieldsAddField' %} <img src="./images/arrow_blue.gif" alt="" /></button>
					 &nbsp; <input type="button" value="{% lang 'FormFieldsDeleteSelected' %}" onclick="DeleteSelectedFormFields()" class="FormButton" style="width: auto; display:{{ FormFieldsHideDeleteButton|raw }}" />
				</p>
			</td>
		</tr>
		<tr>
