	...
	<div id="box">
		...
		<table>
		  ...
		  <tr>
			<td class="HelpInfo">
				{{ Message|raw }}
				<div style="{{ HideInstallWarning|raw }}" class="MessageBox MessageBoxInfo">
					{{ InstallWarning|raw }}
				</div>
			</td>
		  </tr>
			...
			<td>
				<table>
					...
					<tr style="{{ HideLicenseKey|raw }}">
						...
						<td><input type="text" name="LK" id="LK" class="Field250" value="{{ LicenseKey|raw }}"> <img onmouseout="HideHelp('keyhelp');" onmouseover="ShowHelp('keyhelp', '{% lang 'LicenseKey' %}', '{% lang 'LicenseKeyHelp' %}')" src="images/help.gif" width="24" height="16" border="0"><div style="display:none" id="keyhelp"></div></td>
					</tr>
					<tr>
					...
					<tr style="{{ HideTrialFields|raw }}">
						<td nowrap style="padding:0px 10px 0px 10px"><span class="Required">*</span> {% lang 'FullName' %}:</td>
						<td><input type="text" name="FullName" id="FullName" class="Field150" value="{{ FullName|raw }}"> <img onmouseout="HideHelp('fullnamehelp');" onmouseover="ShowHelp('fullnamehelp', '{% lang 'FullName' %}', '{% lang 'InstallFullNameHelp' %}')" src="images/help.gif" width="24" height="16" border="0">
					...
					<tr style="{{ HideTrialFields|raw }}">
						...
						<td><input type="text" name="PhoneNumber" id="PhoneNumber" class="Field150" value="{{ PhoneNumber|raw }}"> <img onmouseout="HideHelp('phonenohelp');" onmouseover="ShowHelp('phonenohelp', '{% lang 'PhoneNo' %}', '{% lang 'PhoneNoHelp' %}')" src="images/help.gif" width="24" height="16" border="0" />
		...
		<div style="padding:10px; margin-bottom:20px; text-align:center" class="PageFooter">
			...
			Powered by <a href="http://www.interspire.com/shoppingcart/" target="_blank">Interspire Shopping Cart {{ ProductVersion|raw }}</a> &copy; 2004-{{ Year|raw }} Interspire Pty. Ltd.
		</div>
	</div>
	</form>
