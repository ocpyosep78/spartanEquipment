<form method="post" action="#" onsubmit="Order.SaveShipment(); return false;" id="ShipmentDetails">
	...
	<div id="ModalTitle">
		{% lang 'CreateShipmentFromOrder' %} #{{ OrderId|raw }} ({{ OrderDate|raw }})
	</div>
	<div id="ModalContent" style="min-height: 100px; max-height: 400px; overflow: auto;">
		...
		<table cellspacing="5" cellpadding="0" border="0" width="100%">
			...
			<tr>
				...
				<td>
					<input type="text" class="Field300" name="shiptrackno" value="{{ TrackingNumber|raw }}" />
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<textarea name="shipcomments" cols="10" rows="4" class="Field300">{{ OrderComments|raw }}</textarea>
				</td>
			</tr>
