									...
									<tr>
										...
										<td>
											<div style="padding: 10px 0px 0px 10px;">
												%%LNG_EmailFormat%%: 
												<select name="MailNewsletterFormat" id="MailNewsletterFormat">
													<option value="t">%%LNG_Text%%</option>
													<option value="h">%%LNG_HTML%%</option>
												</select>
											</div> 
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<div style="padding: 10px 0px 10px 10px;">
												%%LNG_EmailFormat%%: 
												<select name="MailOrderFormat" id="MailOrderFormat">
													<option value="t">%%LNG_Text%%</option>
													<option value="h">%%LNG_HTML%%</option>
												</select>
											</div> 
								...
								<table id="sectionUpdates" style="display:block" border="0" cellspacing="0" cellpadding="2" class="panel">
									...
									<tr>
										...
										<td>
											<div style="padding: 10px 0px 10px 10px;">
												%%LNG_EmailFormat%%: 
												<select name="MailProductUpdatesFormat"  id="MailProductUpdatesFormat">
													<option value="t">%%LNG_Text%%</option>
													<option value="h">%%LNG_HTML%%</option>
												</select>
											</div> 
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		if("%%GLOBAL_UseMailerForNewsletter%%" == "1") {
			...
			if('%%GLOBAL_MailNewsletterFormat%%' == 'h') {
				$('#MailNewsletterFormat option[value="h"]').attr('selected', 'selected');
			}
		...
		if("%%GLOBAL_UseMailerForOrders%%" == "1") {
			...
			if('%%GLOBAL_MailOrderFormat%%' == 'h') {
				$('#MailOrderFormat option[value="h"]').attr('selected', 'selected');
			}
		...
		if("%%GLOBAL_UseMailAPIForUpdates%%" == "1") {
			...
			if('%%GLOBAL_MailProductUpdatesFormat%%' == 'h') {
				$('#MailProductUpdatesFormat option[value="h"]').attr('selected', 'selected');
			}
		}
		else {
			$('#sectionUpdates').hide();
