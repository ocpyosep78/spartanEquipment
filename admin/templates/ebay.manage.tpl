	...
	<div class="BodyContainer">
		...
		<tr>
			<td>
				<ul id="tabnav">
					<li style="{{ ShowTab|raw }}"><a href="#" id="tab0" onclick="ShowTab(0);return false;">{% lang 'LiveEbayListing' %}</a></li>
					<li style="{{ ShowTab|raw }}"><a href="#" id="tab1" onclick="ShowTab(1);return false;">{% lang 'EbayListingTemplate' %}</a></li>
		...
		<tr>
			<td>
				<div id="div0" style="padding-top: 10px;{{ ShowTab|raw }}">
					<table id="IntroTable" cellspacing="0" cellpadding="0" width="100%">
						<tr>
							<td colspan="2" class="Intro">
								{{ ManageEbayLiveListingIntro|raw }}
								{{ EbayLiveListingMessage|raw }}
							</td>
						</tr>
						<tr>
							<td class="Intro" style="{{ ShowListingOptions|raw }}">
								<form id="ebaylistingaction" method="post">
									<select class="Field250" name="ListingActionSelect" id="ListingActionSelect" {{ DisableListingActionDropdown|raw }}>
									...
									<input type="button" style="width: 40px;" class="FormButton" value="Go" name="EbayLiveListingActionButton" id="ebayLiveListingActionButton" {{ DisableListingActionDropdown|raw }}>
								</form>
							</td>
							<td class="SmallSearch" align="right">
								<table id="Table16" style="{{ DisplayListingSearch|raw }}">
									<tr>
										<form action="index.php?ToDo=viewEbay&currentTab=0{{ SortURL|raw }}" method="get" onsubmit="return ValidateForm(CheckSearchForm('listing'))">
										<td nowrap>
										...
										<td nowrap>
											...
											<input name="searchQueryListing" id="searchQueryListing" type="text" value="{{ ListingQuery|raw }}" id="SearchQuery" class="Button" size="20" />&nbsp;
					...
					<form id="deleteebaylivelisting" method="post" action="index.php?ToDo=deleteLocalEbayListing">
						<div class="GridContainer">
							{{ EbayListingDataGrid|raw }}
						</div>
					</form>
				</div>
				<div id="div1" style="padding-top: 10px;{{ ShowTab|raw }}">
					<table id="IntroTable" cellspacing="0" cellpadding="0" width="100%">
						<tr>
							<td colspan="2" class="Intro" >
								<div style="padding-bottom:5px;">{% lang 'ManageEbayTemplateIntro' %}</div>
								{{ EbayListingTemplateMessage|raw }}
							</td>
						</tr>
						<tr>
							<td>
								...
								<input type="button" name="IndexDeleteButton" value="{% lang 'DeleteSelected' %}" id="IndexDeleteButton" class="SmallButton" {{ DisableTemplateDelete|raw }} />
							</td>
							<td class="SmallSearch" align="right">
								<table id="Table16" style="{{ DisplayTemplateSearch|raw }}">
									<tr>
										<form action="index.php?ToDo=viewEbay&currentTab=1{{ SortURL|raw }}" method="get" onsubmit="return ValidateForm(CheckSearchForm('Template'))">
										<td nowrap>
											<input type="hidden" name="ToDo" value="viewEbay">
											<input type="hidden" name="currentTab" value="1">
											<input name="searchQueryTemplate" id="searchQueryTemplate" type="text" value="{{ TemplateQuery|raw }}" id="SearchQuery" class="Button" size="20" />&nbsp;
											<input type="image" name="SearchButton" id="SearchButton" style="padding-left: 10px; vertical-align: top;" src="images/searchicon.gif" border="0" />
					...
					<form id="deleteebaytemplate" action="index.php?ToDo=DeleteEbayTemplate" method="post">
						<div class="GridContainer">
							{{ EbayTemplateDataGrid|raw }}
						</div>
					</form>
				</div>
				<div id="div2" style="padding-top: 10px;">
					<form action="index.php?ToDo={{ FormActionEbayConf|raw }}" method="post" onsubmit="return Ebay.CheckManageEbayForm();">
						<table width="100%" class="IntroTable">
							<tr>
								<td class="Intro">
									{% lang 'EbaySettingsIntro' %}
									{{ EbayConfigMessage|raw }}
								</td>
							</tr>
							<tr>
						...
						<table width="100%" class="Panel">
							...
							<tr>
								...
								<td>
									<input type="text" id="ebaydevid" name="EbayDevId" class="Field250" value="{{ EbayDevId|raw }}">
							...
							<tr>
								...
								<td>
									<input type="text" id="ebayappid" name="EbayAppId" class="Field250" value="{{ EbayAppId|raw }}">
							...
							<tr>
								...
								<td>
									<input type="text" id="ebaycertid" name="EbayCertId" class="Field250" value="{{ EbayCertId|raw }}">
							...
							<tr>
								...
								<td>
									<input type="text" id="ebayusertoken" name="EbayUserToken" class="Field250" value="{{ EbayUserToken|raw }}">
							...
							<tr>
								...
								<td>
									<select name="EbayTestMode" id="EbayTestMode" class="Field250">
										<option id="productionSite" {{ DisableProd|raw }} value="production" {% if EbayTestMode == 'production' %}selected="selected"{% endif %}>{{ lang.EbayModeProduction }}</option>
