	...
	<table class="OuterPanel">
	  <tr>
		<td class="Heading1" id="tdHeading">{% lang 'SearchOrders' %}</td>
		</tr>
		<tr>
		<td class="Intro">
			...
			<td>
			  <table class="Panel">
				...
				<tr>
					...
					<td>
						{% lang 'SearchFrom' %} {{ CurrencyTokenLeft|raw }}<input type="text" id="totalFrom" name="totalFrom" class="Field50"> {{ CurrencyTokenRight|raw }} {% lang 'SearchTo' %}
						{{ CurrencyTokenLeft|raw }}<input type="text" id="totalTo" name="totalTo" class="Field50"> {{ CurrencyTokenRight|raw }}
					</td>
				</tr>
				<tr><td class="Gap" colspan="2"></td></tr>
			 </table>
