...
<tr>
	...
	<td>
		<input type="text" id="FieldSeparator" name="CSV[FieldSeparator]" style="width: 50px;" maxlength="3" value="{{ SettingFieldSeparator|raw }}" />
...
<tr>
	...
	<td>
		<input type="text" id="FieldEnclosure" name="CSV[FieldEnclosure]" style="width: 50px;" maxlength="1" value="{{ SettingFieldEnclosure|raw }}" />
...
<tr>
	...
	<td>
		<label><input type="checkbox" id="IncludeHeader" name="CSV[IncludeHeader]" value="1" {{ SettingIncludeHeader|raw }} />{% lang 'YesIncludeHeader' %}</label>&nbsp;
...
<tr>
	...
	<td>
		<label><input type="checkbox" id="BlankLine" name="CSV[BlankLine]" value="1" {{ SettingBlankLine|raw }} />{% lang 'YesBlankLine' %}</label>&nbsp;
	</td>
</tr>
<tr>
	<td class="FieldLabel">
	...
	<td>
		<select id="SubItems" name="CSV[SubItems]">
			<option value="combine" {{ SettingcombineSelected|raw }}>{% lang 'CombineSubItems' %}</option>
			<option value="expand" {{ SettingexpandSelected|raw }}>{% lang 'ExpandSubItems' %}</option>
			<option value="rows" {{ SettingrowsSelected|raw }}>{% lang 'RowsSubItems' %}</option>
		</select>
		...
		<div style="margin-top: 3px; {{ DisplaySubItems|raw }}" id="SubItemToggle">
			<img src="images/nodejoin.gif" style="vertical-align: middle;" />
			{% lang 'SubItemSeparator' %}: <input type="text" id="SubItemSeparator" name="CSV[SubItemSeparator]" style="width: 50px;" maxlength="1" value="{{ SettingSubItemSeparator|raw }}" />
...
<tr>
	...
	<td>
		<select class="Field100" name="CSV[LineEnding]" id="LineEnding">
			<option value="Windows" {{ SettingWindowsSelected|raw }}>Windows</option>
			<option value="Unix" {{ SettingUnixSelected|raw }}>Mac/Unix</option>
		</select>
	</td>
</tr>
