					...
					<div id="div0">
						...
						<table width="100%" class="Panel HideWhenNoVendor" style="display: none">
							...
							<tr>
								...
								<td>
									{{ LeftCurrencyToken|raw }} <input type="text" name="paymentamount" class="Field50" id="paymentamount" /> {{ RightCurrencyToken|raw }}
...
$(document).ready(function() {
	$('#paymentmethod').autocomplete([{{ PaymentMethodList|raw }}]);
});
