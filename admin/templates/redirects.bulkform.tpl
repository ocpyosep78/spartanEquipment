<script type="text/javascript" src="../javascript/jquery/plugins/ajax.file.upload.js?{{ JSCacheToken|raw }}"></script>
...
<input type="file" id="BulkImportRedirectsFile" name="BulkImportRedirectsFile" />&nbsp;{{ ImportMaxSize|raw }}<br /><br />
