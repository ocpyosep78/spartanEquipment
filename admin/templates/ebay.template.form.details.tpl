		...
		{{ form.startRow({ 'label': lang.QuantityToSell, 'required': true }) }}
			...
			<div class="NodeJoin" {% if quantityOption != 'more' %}style="display: none;"{% endif %}>
				...
				<div style="padding-top:10px">
					...
					<ul>
						<li>{{ lang.SellMoreRequirement1|raw }}</li>
						<li>{{ lang.SellMoreRequirement2|raw }}</li>
						<li>{{ lang.SellMoreRequirement3|raw }}</li>
					</ul>
				</div>
			</div>
		{{ form.endRow }}
...
<div class="mainContent" id="paymentTabContent" style="display: none;">
	{{ form.startForm }}
		...
		{% if options.paypal_required %}
			<p class="MessageBox MessageBoxInfo">{{ lang.EbayPayPalRequired|raw }}</p>
		{% endif %}
...
<div class="mainContent" id="shippingTabContent" style="display: none;">
	{{ form.startForm }}
		...
		<p class="intro MessageBox MessageBoxInfo">{{ lang.ShippingDimensionsWarning|raw }}</p>
