		...
		<table id="Table13" cellSpacing="0" cellPadding="0" width="100%">
			...
			<tr>
				<td class="Intro">
					...
					{{ Message|raw }}
					<p>
						<input type="button" name="IndexAddButton" value="{% lang 'AddExportTemplate' %}..." id="IndexCreateButton" class="SmallButton" onclick="document.location.href='index.php?ToDo=createExportTemplate'" /> &nbsp;<input type="button" name="IndexDeleteButton" value="{% lang 'DeleteSelected' %}" id="IndexDeleteButton" class="SmallButton" style="min-width: 110px;" onclick="ConfirmDeleteSelected()" {{ DisableDelete|raw }} />
					</p>
				</td>
			</tr>
			<tr>
