<div class="toolbar">
	...
	<a style="position:absolute; left:5px; top:8px; width:59px" class="button" href="{{ ShopPath|raw }}/admin/index.php?ToDo=viewOrders" type="submit">{% lang 'AllOrders' %}</a>
	<a class="button" href="#searchForm">{% lang 'Search' %}</a>
</div>
<ul selected="true">
	{{ Message|raw }}
	{{ OrderGrid|raw }}
	<li style="text-align:center">{{ SmallNav|raw }}&nbsp;</li>
...
<script type="text/javascript">
	...
	function searchRedir() {
		...
		document.location.href = "{{ ShopPath|raw }}/admin/index.php?ToDo=searchOrdersRedirect&SubmitButton1=Search&searchQuery="+q+"&orderStatus="+s+"&paymentMethod=&shippingMethod=&couponCode=&orderFrom=&orderTo=&totalFrom=&totalTo=&dateRange=&fromDate=&toDate=&sortField=orderid&sortOrder=desc";
		return false;
	}
