		...
		<td valign="top">
			...
			<table width="95%" border="0" align="right">
				<tr>
					...
					<td class="text"><a href="mailto:{{ ToEmail|raw }}">{{ ToName|raw }}</a></td>
				</tr>
				<tr>
					<td width="150" class="text">{% lang 'GiftCertificateSentFrom' %}:</td>
					<td class="text"><a href="mailto:{{ FromEmail|raw }}">{{ FromName|raw }}</a></td>
				</tr>
				<tr>
					<td width="150" class="text">{% lang 'GiftCertificateMessage' %}:</td>
					<td class="text">{{ Message|raw }}</td>
				</tr>
			</table>
		</td>
	</tr>
