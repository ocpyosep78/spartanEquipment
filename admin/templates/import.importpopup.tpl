...
<iframe src="index.php?ToDo=import{{ Type|raw }}&amp;Step=4&amp;ImportSession={{ ImportSession|raw }}" width="1" height="1" frameborder="0" border="0"></iframe>