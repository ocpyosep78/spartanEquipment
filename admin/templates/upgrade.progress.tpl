...
<script type="text/javascript">
	...
	UpdateProgress('{{ RunningStepOfX|raw }}', '{{ PercentComplete|raw }}');
</script>
<!-- iframe which does all of the work -->
<iframe src="index.php?ToDo=runUpgrade&random={{ Random|raw }}" width="1" height="1" frameborder="0" border="0"></iframe>